...
const AuthModal = ({ open, onOpenChange, mode, onSwitchMode }: AuthModalProps) => {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md p-0 gap-0 overflow-hidden bg-card border-border">
        ...
        <div className="px-6 pb-6 pt-4 flex flex-col gap-4">
          ...
          <Button variant="outline" className="w-full h-11 gap-3 text-sm font-medium border-border hover:bg-secondary">
          ...
          <p className="text-xs text-muted-foreground text-center leading-relaxed">
            By {isLogin ? "logging in" : "signing up"}, you agree to Lagkit's{" "}
